            ...
            <div class="p-5">
              ...
              <form class="user" method="post">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  <input type="text" name="bio" class="form-control form-control-user" id="exampleInputEmail" placeholder="Your Bio" required>
                </div>
                ...
                if(isset($_POST['register'])){
                  ...
                  $bio=$_POST['bio'];
                  $result = $user->save($firstname,$lastname,$username,$email,$password,$bio);

                  if($result){
                    $user->redirect_js('login.php');
                  }
                }
                ?>
              </form>
