...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="add_user.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
        class="fas fa-download fa-sm text-white-50"></i> Generate User</a>
  </div>
      ...
      <div class="card shadow mb-4">
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <a href='user_action.php?action=delete&user_id=<?php echo $id;?>' class='btn btn-danger btn-sm'
              onclick='return confirm("Are you sure you wanna delete");'>Delete</a>
          ...
          <div class="card shadow mb-4">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <a href='country_action.php?action=delete&country_id=<?php echo $id;?>' class='btn btn-danger btn-sm'
                  onclick='return confirm("Are you sure you wanna delete");'>Delete</a>
                  ...
                  <div class="card shadow mb-4">
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <a href="quiz_action.php?action=delete&quiz_id=<?php echo $id;?>" class='btn btn-danger btn-sm'
                          onclick='return confirm("Are you sure you wanna delete");'>Delete</a>
              ...
              <div class="row">
                ...
                <div class="col-xl-12 col-lg-12">
                  <div class="card shadow mb-4">
                    <!-- Card Header - Dropdown -->
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                      <h6 class="m-0 font-weight-bold text-primary">Question Overview</h6>
                    </div>
                    <!-- Card Body -->
                    <table class="table table-striped">
                      <thead class="bg-dark text-light">
              ...
              <div class="row">
                ...
                <div class="col-xl-12 col-lg-12">
                  <div class="card shadow mb-4">
                    <!-- Card Header - Dropdown -->
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                      <h6 class="m-0 font-weight-bold text-primary">Answer Overview</h6>
                    </div>
                    <!-- Card Body -->
                    <table class="table table-striped">
                      <thead class="bg-dark text-light">
