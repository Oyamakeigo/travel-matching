          ...
          <div class="col-12">
            <div class="card">
              ...
              <!-- action has 3 action ex)delete,update,add -->
                <form action="question_action.php?action=update" method="post" >
                    <input type="hidden" name="question_id" value="<?php echo $_GET['question_id'];?>">
                 <div class="form-group">
                  <label>Question name</label>
                  <input type="text" name="questionname" class="form-control" value="<?php echo $get_question['questionname'];?>">
                 </div>
